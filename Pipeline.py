...
photometry_lib = "/home/thomas.topilko/Desktop/Fiber_Photometry_Analysis"
...
working_directory = "/home/thomas.topilko/Desktop/Fiber_Photometry_Analysis/Test/{0}/{1}".format(experiment, mouse);
...
args = p.set_parameters(files) #Loads all the parameters for the analysis
...
#args["plots_to_display"] = ~args["plots_to_display"] #Turns ON/OFF all the plots at once
...
args["behavior_to_segment"] = "Touching"
...
args["video_photometry"]["resize_video"] = 1.2
args["video_photometry"]["global_acceleration"] = 50
...
behavior_data_x_trimmed = behavior_data_x[int(int(args["photometry_data"]["time_lost"]/2)*args["recording_sampling_rate"]) : int(round((args["video_duration"]-int(args["photometry_data"]["time_lost"]/2))*args["recording_sampling_rate"]))]
